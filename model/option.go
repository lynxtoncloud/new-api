...
func InitOptionMap() {
	...
	common.OptionMap["ModelDisplayName"] = ratio_setting.ModelDisplayName2JSONString()
	common.OptionMap["ModelModalities"] = ratio_setting.ModelModalities2JSONString()
	common.OptionMap["ModelInputTypes"] = ratio_setting.ModelInputTypes2JSONString()
	common.OptionMap["ModelImg"] = ratio_setting.ModelImg2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ModelDisplayName":
		err = ratio_setting.UpdateModelDisplayNameByJSONString(value)
	case "ModelModalities":
		err = ratio_setting.UpdateModelModalitiesByJSONString(value)
	case "ModelInputTypes":
		err = ratio_setting.UpdateModelInputTypesByJSONString(value)
	case "ModelImg":
		err = ratio_setting.UpdateModelImgByJSONString(value)
	case "TopUpLink":
