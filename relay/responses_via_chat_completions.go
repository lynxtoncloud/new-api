...
// responsesViaChatCompletions handles client /v1/responses calls by converting them
// into /v1/chat/completions requests for upstream, then re-emitting the upstream
// chat-completions reply as a Responses-format payload.
